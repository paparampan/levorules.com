...
function CourseCallout({ setRoute }) {
  ...
  const modules = live.length
    ...
    : [
        ...
        { n: '03', title: 'подготовка к практике' },
        { n: '04', title: 'создание сервитора: ядро курса' },
        { n: '05', title: 'работа с сервитором' },
        { n: '06', title: 'продвинутые техники' },
        { n: '07', title: 'деактивация, отпуск, трансмутация' },
        { n: '08', title: 'примеры и типичные ошибки' },
        { n: '09', title: 'психологическая и онтологическая рамка' },
        { n: '10', title: 'дальнейший путь и интеграция' },
      ];
        ...
        <div style={{ marginTop: 18, display: 'grid', gridTemplateColumns: '1.35fr 1fr', gap: 56, alignItems: 'center' }}>
          <div>
            ...
            <p style={{ marginTop: 24, color: 'var(--bone)', fontSize: 17, lineHeight: 1.55, maxWidth: 460 }}>
              История, источники и пошаговая работа с сервиторами: от замысла и дневника
              до проверки результата и завершения. Базовое знакомство с хаос-магией пригодится.
            </p>
            <p style={{ marginTop: 14, color: 'var(--purple)', fontSize: 17, lineHeight: 1.55, maxWidth: 460,
              fontWeight: 700, letterSpacing: '0.01em' }}>
              Ответственность за решения всё равно остаётся у тебя.
            </p>
