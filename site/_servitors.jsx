        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '80px 32px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 1,
            ...
            {[
              ...
              { l: 'H', t: 'История исправлений', d: 'Открытый журнал правок: что и почему изменилось после сверки с первоисточниками. NotebookLM досочинил часть конкретных деталей — здесь честно перечислено, что убрано и переформулировано. С благодарностью читателям, заметившим неточности.', f: 'prilozhenie-h-istoriya-ispravleniy.pdf' },
              { l: '✱', t: 'Курс одним PDF', d: 'Полная редакция 2026-04-18 (испр. 2026-06-18) в одном файле на 134 страницы. Все модули и приложения вместе — для оффлайн-чтения и печати.', f: 'servitors.pdf', isFull: true },
            ].map((a, i) => (
