        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '80px 32px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 1, background: 'var(--border)', border: '1px solid var(--border)' }}>
            {[
              ...
              { t: 'КЕЙСЫ', b: 'Документированные модели Кэрролла, Хайна и Брэнда, авторские сопоставления и типичные ошибки.' },
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '80px 32px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 1,
            ...
            {[
              ...
              { l: '✱', t: 'Курс одним PDF', d: 'Актуальная редакция 2026-07-10: все 11 модулей в одном файле для оффлайн-чтения и печати. Приложения скачиваются отдельными файлами выше.', f: 'servitors.pdf', isFull: true },
            ].map((a, i) => (
